    ...
    quiz: [
      {
        ...
        correctAnswer: 1,
        explanation:
          "JSX (JavaScript XML) is a syntax extension that allows you to write HTML-like code in JavaScript, making React components more readable.",
      },
      {
        id: 2,
        question:
        ...
        correctAnswer: 1,
        explanation:
          "useState is the React hook used to add state to functional components, returning the current state and a function to update it.",
      },
      {
        id: 3,
      ...
      },
      {
        ...
        correctAnswer: 3,
        explanation:
          "The virtual DOM is a JavaScript representation of the real DOM kept in memory, allowing React to efficiently update the UI by comparing and updating only what changed.",
      },
      {
        id: 5,
        question:
        ...
        correctAnswer: 1,
        explanation:
          "Props (properties) are used to pass data from parent components to child components in React, making components reusable and configurable.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    quiz: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "The borrow checker analyzes code at compile time to ensure that references are valid and ownership rules are followed, preventing memory safety issues.",
      },
      {
        id: 5,
