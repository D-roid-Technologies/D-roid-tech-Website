...
const initialState: ProjectState = {
  projects: [
    ...
    },
    {
      ...
      descriptionUrl: "",
      summary:
        "Tickle My Fancy is an ongoing dating app project developed for WellBody Co. This paid project, authored by D'roid, focuses on creating a platform where users can explore their desires, share their boundaries, and connect with like-minded individuals.",
      startDate: "2025-01-10",
      client: "WellBody Co.",
      team: ["Chinaza Eze", "Marcus Lee", "Fatima Noor"],
