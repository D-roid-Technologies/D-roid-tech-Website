    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#fff" }}>
      ...
      >
        ...
        >
          ...
          <h1
            style={{ fontSize: "2.5rem", margin: "1rem 0", fontWeight: "bold" }}
          >
            {storyData.title}
          </h1>
      ...
      <div className={styles.container}>
        <div className={styles.detailsGrid}>
          <div>
            ...
            <img
              src={
                storyData.thumbnail || "/placeholder.svg?height=400&width=300"
              }
              alt={storyData.title}
        ...
        {storyData.additionalInfo &&
          Object.keys(storyData.additionalInfo).length > 0 && (
            <div className={styles.additionalInfo}>
              <h3 className={styles.additionalInfoTitle}>Additional Details</h3>
              <div className={styles.additionalGrid}>
                {Object.entries(storyData.additionalInfo).map(
                  ([key, value]) => (
