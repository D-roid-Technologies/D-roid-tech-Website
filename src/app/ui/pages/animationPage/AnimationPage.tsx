...
const stories: Story[] = [
    {
        ...
        summary: "Two brothers, separated by an enemy invasion, embark on separate journeys and are reunited in an unexpected way, discovering the strength of family and destiny along the way.",
    ...
    },
    {
        ...
        summary: "A group of ambitious young men obsessed with wealth and status learn the cost of living in a world where money is everything, and nothing is as valuable as it seems.",
    ...
    },
    {
        ...
        summary: "A young African female born with sickle cell disease overcomes societal stigma and personal challenges to inspire hope and empowerment in others facing similar struggles.",
    ...
    },
    {
        ...
        releaseDate: "January 20, 2025",
        summary: "A determined clan rises from humble beginnings to become the strongest force on the planet through unity, sacrifice, and unwavering perseverance.",
        url: "/stories/ai-finds-soul",
        category: 'Animated',
            ...
            <div className="wrapper" style={{ padding: "40px" }}>
                ...
                >
                    {stories.map((story, idx) => (
                        ...
                        >
                            <div style={{ height: "150px", backgroundColor: "#f3f3f3", backgroundImage: `url(${story.thumbnail})`, backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: "cover" }}>
                                <span style={{ marginTop: "60px", padding: "8px", backgroundColor: "red"}}>{story.category}</span>
                            ...
                            <div style={{ padding: "20px" }}>
                                ...
                                <p style={{ margin: "10px 0", color: "#555" }}>{story.summary}</p>
