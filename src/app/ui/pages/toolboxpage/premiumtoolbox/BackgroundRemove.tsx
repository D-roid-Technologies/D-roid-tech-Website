...
const BackgroundRemove: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const handleRemoveBackground = async () => {
    ...
    setTimeout(() => {
      // setResultURL("/result-sample.png"); // Placeholder result
      setResultURL("./");
      setLoading(false);
    }, 3000);
  };
  ...
  return (
    <div className="ai-remover-container">
      <h1 className="ai-remover-title">AI Background Remover</h1>
      <div className="ai-remover-upload-section">
        <input type="file" accept="image/*" onChange={handleFileChange} />
        {previewURL && (
          <div className="ai-remover-preview">
            <img src={previewURL} alt="Preview" className="ai-remover-image" />
          </div>
        )}
        <button
          className="ai-remover-button"
      ...
      {resultURL && (
        <div className="ai-remover-result">
          <h2>Result:</h2>
          <img src={resultURL} alt="Result" className="ai-remover-image" />
          <a href={resultURL} download className="ai-remover-download">
            Download
          </a>
        </div>
      )}
