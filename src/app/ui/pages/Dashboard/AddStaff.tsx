...
const StaffForm: React.FC<StaffFormProps> = ({
    ...
    if (initialData && mode === "edit") {
      setFormData({
        ...
        achievements: initialData.achievements?.length
          ...
          : [""],
        specializations: initialData.specializations?.length
  ...
  const handleReset = () => {
    if (mode === "edit" && initialData) {
      ...
      // Reset to empty form when adding
      setFormData({
        firstName: "",
        lastName: "",
        email: "",
                ...
                <div className={styles.inputRow}>
                  ...
                  <div className={styles.inputField}>
                    ...
                    >
                      ...
                      <option value="K-2">Playgroup/Crèche</option>
                      <option value="3-5">Nursery 1</option>
                      <option value="6-8">Nursery 2</option>
                      <option value="9-12">Primary 1</option>
                      <option value="9-12">Primary 2</option>
                      <option value="9-12">Primary 3</option>
                      <option value="9-12">Primary 4</option>
                      <option value="9-12">Primary 5</option>
                      <option value="9-12">Primary 6</option>
                      <option value="9-12">JSS 1</option>
                      <option value="9-12">JSS 2</option>
                      <option value="9-12">JSS 3</option>
                      <option value="9-12">SSS 1</option>
                      <option value="9-12">SSS 2</option>
                      <option value="9-12">SSS 3</option>
