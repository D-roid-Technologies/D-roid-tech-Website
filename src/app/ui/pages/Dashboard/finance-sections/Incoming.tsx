...
const IncomingDetail: React.FC = () => {
  const sectionData = financeSectionsData.find((section) => section.id === "incoming")
    ...
    <div className={styles.detailContainer}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.overviewContent}>
          <span className={`${styles.currentValue} ${styles.incomingValue}`}>{sectionData.currentValue}</span>
