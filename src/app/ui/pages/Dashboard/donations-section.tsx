...
import { Plus, Filter, Download, DollarSign, Target, Users, Heart, Edit, Trash2 } from "lucide-react"
                ...
                <tbody>
                  {filteredDonations.map((donation) => (
                    <tr key={donation.id} className={componentStyles.tableRow}>
                      ...
                      <td className={componentStyles.tableCell}>${donation.amount}</td>
                      ...
                      <td className={componentStyles.tableCell}>
                        <span
                          className={`${componentStyles.badge} ${donation.status === "Completed"
