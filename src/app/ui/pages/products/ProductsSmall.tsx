    ...
    <section className="product_sec">
      <div className="wrapper">
        ...
        <p>
          ...
          blend technology, creativity, and innovation. From AI-driven solutions
          to dynamic web platforms and immersive animations, every project
          reflects our commitment to excellence, forward-thinking design, and
          real-world impact.
        </p>
        <div className="group">
