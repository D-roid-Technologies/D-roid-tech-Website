...
import { FaAccessibleIcon, FaCode, FaPencilRuler, FaServer } from "react-icons/fa";
    ...
    const devPhases = [
        {
            ...
            summary: "Mobile-first responsive design ensures your website delivers a fast, accessible, and visually polished experience on every screen size, starting from smartphones upward."
        },
        {
            ...
            url: "",
            summary: "We build scalable, high-performing front-end interfaces using React, Vue, or Angular—tailored to your business goals and user experience expectations."
        },
        {
            ...
            icon: FaCode({ size: 24 }),
            url: "",
            summary: "We design and build tailored user interfaces that blend innovation with usability to deliver exceptional user experiences."
        },
        {
            ...
            url: "",
            summary: "We enhance your digital product’s speed and responsiveness to deliver fast, smooth, and reliable experiences for every user."
        },
        {
            ...
            icon: FaServer({ size: 24 }),
            url: "",
            summary: "We expertly integrate APIs and manage application state to deliver fast, dynamic, and scalable user experiences."
        },
        {
            ...
            icon: FaServer({ size: 24 }),
            url: "",
            summary: "We ensure your website looks and functions flawlessly across all modern browsers, delivering a uniform experience to every user."
        },
    ];
        ...
        <div>
            ...
            <div className="software-main">
                <div className="software-main-content">
                    ...
                    <p>
                        We design and develop modern, responsive, and scalable front-end interfaces
